      ...
      <div class="row">
        <nav aria-label="breadcrumb">
             <ol class="breadcrumb">
               ...
               <li class="breadcrumb-item text-dark opacity-5"><a href="javascript"><?php echo $month."";?></a></li>
             </ol>
...
<br />
                                  <div class="modal-footer justify-content-between">
                                                <input type="submit" class="btn btn-primary w-auto me-2" name="delete_bill" value="Delete"/>
                                            
                                                <button type="button" class="btn bg-gradient-dark w-auto me-2" data-bs-dismiss="modal">Close</button>
                                                <input type="submit" class="btn btn-primary w-auto me-2" name="submit_bill" value="Save"/>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
