          ...
          <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="bill_list.php">List Bills</a></li>
...
<div class="card-body px-1 pt-1 pb-2">
              <form method="post" action="../bill_update_save.php">
                <div class="container">
                  <div class="row">
                    <div class="col-sm">
              ...
              <?php if (isset($_SESSION['success_message']) && !empty($_SESSION['success_message'])) { ?>
                    ...
                    ?>
                  <div class="form-group">
                      <input type="submit" class="btn btn-primary" id = "updatebill" name="updatebill" value="Save"/>
                  </div>
              </form>
