	...
	function submitForm(){
	     ...
	     if(document.getElementById("username").value.trim()==="" && document.getElementById("username").value!==null){
	      $('#message1').css('color','red');
			 $('#message1').html('Please enter your Gov Email');   
	     }
	      ...
	      if(password==confirm){
	          ...
	          $('#message1').html('Success! You will be redirected.');  
...
//continue			  
setTimeout(function () {
   window.location.href = "http://requestmyleave.com/home.php"; //will redirect to home page
}, 5000); //will call the function after 5 secs.  Maybe make it 10?
